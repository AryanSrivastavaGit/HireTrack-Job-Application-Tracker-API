...
const HireTrackPage = () => {
    ...
    const addRoundDetail = () => {
        setHireTrackData(prev => ({ ...prev, roundDetails: [...prev.roundDetails, { round: '', description: '', outcome: 'PENDING' }] }));
    }
            ...
            <div>
                ...
                {hireTrackData.companySources.map((companySource, index) => (
                    <div key={index}>
                        ...
                        <button onClick={() => removeListItem('companySources', index)}>Remove Company Source</button>
                    </div>
                ))}
                <button onClick={addCompanySource}>Add Company Source</button>
            </div>
